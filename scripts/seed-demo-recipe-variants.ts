...
export const DISHES: DishSpec[] = [
  // ---- Flagship dishes (spec-named variant sets) ----
  {
    ...
    ingredients: [
      ...
      { name: 'Curd', qty: 0.5, unit: 'kg', notes: 'Hung for 30 minutes' },
      ...
      { name: 'Cooking Oil', qty: 0.1, unit: 'liter', notes: 'For basting' },
      { name: 'Capsicum', qty: 0.3, unit: 'kg', notes: 'Cut into squares' },
      { name: 'Onion', qty: 0.3, unit: 'kg', notes: 'Cut into squares' },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Cooking Oil', qty: 0.15, unit: 'liter' },
    ],
    steps: [
    ...
    extraVariants: [
      {
        ...
        extraIngredients: [{ name: 'Fresh Cream', qty: 200, unit: 'g' }, { name: 'Cheese', qty: 0.1, unit: 'kg', notes: 'Grated into marinade' }],
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Maida', qty: 0.2, unit: 'kg', notes: 'For binding the koftas' },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Cooking Oil', qty: 0.3, unit: 'liter' },
    ],
    steps: [
    ...
    extraVariants: [
      {
        ...
        extraIngredients: [{ name: 'Onion', qty: 0.3, unit: 'kg', notes: 'Extra, fried crisp for garnish' }],
  ...
  },
  {
    ...
    ingredients: [
      ...
      { name: 'Cooking Oil', qty: 0.25, unit: 'liter' },
    ],
    steps: [
    ...
    extraVariants: [
      {
        ...
        extraIngredients: [{ name: 'Cooking Oil', qty: 0.05, unit: 'liter', notes: 'Coconut oil for tempering' }],
  ...
  { itemName: 'Hara Bhara Kabab', summary: 'Spinach and green pea patties, shallow fried and lightly spiced.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '3 pieces per portion',
    ingredients: [{ name: 'Spinach', qty: 1, unit: 'kg', notes: 'Blanched and chopped' }, { name: 'Green Peas', qty: 0.5, unit: 'kg', notes: 'Boiled' }, { name: 'Potato', qty: 0.5, unit: 'kg', notes: 'Boiled and mashed' }, { name: 'Green Chilli', qty: 30, unit: 'g', notes: 'Finely chopped' }, { name: 'Besan', qty: 0.1, unit: 'kg', notes: 'For binding' }, { name: 'Cooking Oil', qty: 0.3, unit: 'liter', notes: 'For shallow frying' }],
  ...
  { itemName: 'Veg Seekh Kabab', summary: 'Skewered minced vegetable kababs grilled in the tandoor.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '3 pieces per portion',
    ingredients: [{ name: 'Mushroom', qty: 0.5, unit: 'kg', notes: 'Finely chopped' }, { name: 'Potato', qty: 0.8, unit: 'kg', notes: 'Boiled and mashed' }, { name: 'Green Peas', qty: 0.3, unit: 'kg', notes: 'Boiled and mashed' }, { name: 'Besan', qty: 0.15, unit: 'kg', notes: 'Roasted, for binding' }, { name: 'Garam Masala', qty: 15, unit: 'g' }, { name: 'Cooking Oil', qty: 0.15, unit: 'liter', notes: 'For basting' }],
  ...
  { itemName: 'Fish Amritsari', summary: 'Crisp batter-fried fish, an Amritsari street-food classic.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '3 pieces per portion',
    ingredients: [{ name: 'Fish', qty: 3, unit: 'kg', notes: 'Boneless fillets, cut into strips' }, { name: 'Besan', qty: 0.5, unit: 'kg', notes: 'For the batter' }, { name: 'Ginger', qty: 50, unit: 'g', notes: 'Paste' }, { name: 'Garlic', qty: 50, unit: 'g', notes: 'Paste' }, { name: 'Carom Seeds (Ajwain)', qty: 15, unit: 'g' }, { name: 'Cooking Oil', qty: 1, unit: 'liter', notes: 'For deep frying' }],
  ...
  { itemName: 'Mutton Seekh Kabab', summary: 'Skewered minced mutton kababs grilled in the tandoor.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '3 pieces per portion',
    ingredients: [{ name: 'Mutton', qty: 3, unit: 'kg', notes: 'Minced (keema)' }, { name: 'Onion', qty: 0.3, unit: 'kg', notes: 'Finely chopped' }, { name: 'Ginger', qty: 60, unit: 'g', notes: 'Paste' }, { name: 'Garlic', qty: 60, unit: 'g', notes: 'Paste' }, { name: 'Garam Masala', qty: 20, unit: 'g' }, { name: 'Cooking Oil', qty: 0.15, unit: 'liter', notes: 'For basting' }],
  ...
  { itemName: 'Palak Paneer', summary: 'Cottage cheese cubes in a pureed spinach gravy.', yieldQty: 10, yieldUnit: 'kg', yieldNotes: 'Serves approximately 60 guests as a buffet dish',
    ingredients: [{ name: 'Paneer', qty: 3, unit: 'kg', notes: 'Cut into cubes' }, { name: 'Spinach', qty: 3, unit: 'kg', notes: 'Blanched and pureed' }, { name: 'Onion', qty: 0.8, unit: 'kg', notes: 'Chopped' }, { name: 'Tomato', qty: 0.5, unit: 'kg', notes: 'Chopped' }, { name: 'Garlic', qty: 50, unit: 'g', notes: 'Paste' }, { name: 'Fresh Cream', qty: 300, unit: 'g' }],
  ...
  { itemName: 'Butter Naan', summary: 'Soft leavened tandoori bread finished with butter.', yieldQty: 100, yieldUnit: 'pieces',
    ingredients: [{ name: 'Maida', qty: 5, unit: 'kg' }, { name: 'Curd', qty: 0.5, unit: 'kg' }, { name: 'Butter', qty: 0.5, unit: 'kg' }, { name: 'Sugar', qty: 0.05, unit: 'kg' }],
  ...
  { itemName: 'Missi Roti', summary: 'Spiced gram-flour flatbread baked in the tandoor.', yieldQty: 100, yieldUnit: 'pieces',
    ingredients: [{ name: 'Besan', qty: 2, unit: 'kg' }, { name: 'Wheat Flour', qty: 3, unit: 'kg' }, { name: 'Carom Seeds (Ajwain)', qty: 20, unit: 'g' }, { name: 'Coriander', qty: 100, unit: 'g', notes: 'Chopped' }, { name: 'Green Chilli', qty: 40, unit: 'g', notes: 'Finely chopped' }, { name: 'Cooking Oil', qty: 0.15, unit: 'liter' }],
  ...
  { itemName: 'Garlic Naan', summary: 'Tandoori naan topped with fresh garlic and coriander.', yieldQty: 100, yieldUnit: 'pieces',
    ingredients: [{ name: 'Maida', qty: 5, unit: 'kg' }, { name: 'Curd', qty: 0.5, unit: 'kg' }, { name: 'Garlic', qty: 300, unit: 'g', notes: 'Finely chopped' }, { name: 'Coriander', qty: 100, unit: 'g', notes: 'Chopped' }, { name: 'Butter', qty: 0.4, unit: 'kg' }],
  ...
  { itemName: 'Tandoori Roti', summary: 'Whole wheat bread baked fresh in the tandoor.', yieldQty: 100, yieldUnit: 'pieces',
    ingredients: [{ name: 'Wheat Flour', qty: 5, unit: 'kg' }, { name: 'Cooking Oil', qty: 0.1, unit: 'liter' }],
  ...
  { itemName: 'Laccha Paratha', summary: 'Multi-layered flaky flatbread, pan-roasted with ghee.', yieldQty: 100, yieldUnit: 'pieces',
    ingredients: [{ name: 'Wheat Flour', qty: 5, unit: 'kg' }, { name: 'Ghee', qty: 500, unit: 'g' }, { name: 'Cooking Oil', qty: 0.2, unit: 'liter' }],
  ...
  { itemName: 'Gulab Jamun', summary: 'Soft milk-solid dumplings soaked in rose-cardamom sugar syrup.', yieldQty: 150, yieldUnit: 'pieces',
    ingredients: [{ name: 'Khoya', qty: 2, unit: 'kg' }, { name: 'Maida', qty: 0.3, unit: 'kg', notes: 'For binding' }, { name: 'Sugar', qty: 3, unit: 'kg', notes: 'For the syrup' }, { name: 'Cardamom', qty: 15, unit: 'g' }, { name: 'Cooking Oil', qty: 2, unit: 'liter', notes: 'For deep frying' }],
  ...
  { itemName: 'Jalebi', summary: 'Crisp fermented batter spirals soaked in sugar syrup, served warm.', yieldQty: 150, yieldUnit: 'pieces',
    ingredients: [{ name: 'Maida', qty: 2, unit: 'kg' }, { name: 'Curd', qty: 0.3, unit: 'kg', notes: 'For fermentation' }, { name: 'Sugar', qty: 3, unit: 'kg', notes: 'For syrup' }, { name: 'Cooking Oil', qty: 2, unit: 'liter', notes: 'For deep frying' }],
  ...
  { itemName: 'Tomato Soup', summary: 'Classic cream of tomato soup finished with a swirl of fresh cream.', yieldQty: 10, yieldUnit: 'liter', yieldNotes: 'Approximately 50 bowl portions',
    ingredients: [{ name: 'Tomato', qty: 4, unit: 'kg' }, { name: 'Onion', qty: 0.5, unit: 'kg' }, { name: 'Fresh Cream', qty: 300, unit: 'g' }, { name: 'Butter', qty: 0.1, unit: 'kg' }, { name: 'Black Pepper', qty: 15, unit: 'g' }],
  ...
  { itemName: 'Sweet Corn Soup', summary: 'Comforting corn soup, available in vegetable or chicken preparation.', yieldQty: 10, yieldUnit: 'liter', yieldNotes: 'Approximately 50 bowl portions',
    ingredients: [{ name: 'Sweet Corn', qty: 2, unit: 'kg' }, { name: 'Cooking Oil', qty: 0.05, unit: 'liter' }, { name: 'Maida', qty: 0.1, unit: 'kg', notes: 'For thickening' }, { name: 'Salt', qty: 30, unit: 'g' }],
  ...
  { itemName: 'Hot & Sour Soup', summary: 'Spicy and tangy Indo-Chinese soup with julienned vegetables.', yieldQty: 10, yieldUnit: 'liter', yieldNotes: 'Approximately 50 bowl portions',
    ingredients: [{ name: 'Cabbage', qty: 1, unit: 'kg', notes: 'Julienned' }, { name: 'Carrot', qty: 1, unit: 'kg', notes: 'Julienned' }, { name: 'Capsicum', qty: 0.5, unit: 'kg', notes: 'Julienned' }, { name: 'Vinegar', qty: 100, unit: 'ml' }, { name: 'Soy Sauce', qty: 100, unit: 'ml' }, { name: 'Maida', qty: 0.1, unit: 'kg', notes: 'For thickening' }],
  ...
  { itemName: 'Veg Manchurian', summary: 'Fried vegetable dumplings tossed in a tangy Indo-Chinese sauce.', yieldQty: 25, yieldUnit: 'portions',
    ingredients: [{ name: 'Cabbage', qty: 1.5, unit: 'kg', notes: 'Finely chopped' }, { name: 'Carrot', qty: 0.5, unit: 'kg', notes: 'Finely chopped' }, { name: 'Maida', qty: 0.4, unit: 'kg', notes: 'For binding the dumplings' }, { name: 'Manchurian Sauce', qty: 2, unit: 'kg', notes: 'House-made base sauce' }, { name: 'Cooking Oil', qty: 1, unit: 'liter', notes: 'For deep frying' }],
  ...
  { itemName: 'Chilli Paneer', summary: 'Crisp paneer tossed with capsicum and onion in a spicy sauce.', yieldQty: 25, yieldUnit: 'portions',
    ingredients: [{ name: 'Paneer', qty: 2, unit: 'kg', notes: 'Cut into batons, batter fried' }, { name: 'Capsicum', qty: 0.8, unit: 'kg', notes: 'Cut into squares' }, { name: 'Onion', qty: 0.8, unit: 'kg', notes: 'Cut into squares' }, { name: 'Soy Sauce', qty: 100, unit: 'ml' }, { name: 'Cooking Oil', qty: 0.5, unit: 'liter', notes: 'For frying' }],
  ...
  { itemName: 'Chicken Manchurian', summary: 'Fried chicken tossed in a tangy Indo-Chinese sauce.', yieldQty: 25, yieldUnit: 'portions',
    ingredients: [{ name: 'Chicken', qty: 3, unit: 'kg', notes: 'Boneless, batter fried' }, { name: 'Manchurian Sauce', qty: 2, unit: 'kg', notes: 'House-made base sauce' }, { name: 'Capsicum', qty: 0.5, unit: 'kg', notes: 'Cut into squares' }, { name: 'Cooking Oil', qty: 1, unit: 'liter', notes: 'For deep frying' }],
  ...
  { itemName: 'Chilli Chicken', summary: 'Crisp chicken tossed with capsicum and onion in spicy sauce.', yieldQty: 25, yieldUnit: 'portions',
    ingredients: [{ name: 'Chicken', qty: 3, unit: 'kg', notes: 'Boneless, batter fried' }, { name: 'Capsicum', qty: 0.8, unit: 'kg', notes: 'Cut into squares' }, { name: 'Onion', qty: 0.8, unit: 'kg', notes: 'Cut into squares' }, { name: 'Soy Sauce', qty: 100, unit: 'ml' }, { name: 'Green Chilli', qty: 80, unit: 'g', notes: 'Slit' }],
  ...
  { itemName: 'Prawns Koliwada', summary: 'Crisp fried prawns in a spiced batter, a coastal favourite.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '4 pieces per portion',
    ingredients: [{ name: 'Prawns', qty: 3, unit: 'kg', notes: 'Cleaned and deveined' }, { name: 'Besan', qty: 0.4, unit: 'kg', notes: 'For the batter' }, { name: 'Red Chilli Powder', qty: 30, unit: 'g' }, { name: 'Ginger', qty: 40, unit: 'g', notes: 'Paste' }, { name: 'Garlic', qty: 40, unit: 'g', notes: 'Paste' }, { name: 'Cooking Oil', qty: 1, unit: 'liter', notes: 'For deep frying' }],
  ...
  { itemName: 'Chicken Malai Tikka', summary: 'Creamy cheese-marinated chicken, mildly spiced and grilled.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '4 pieces per portion',
    ingredients: [{ name: 'Chicken', qty: 2.5, unit: 'kg', notes: 'Boneless, cut into chunks' }, { name: 'Fresh Cream', qty: 400, unit: 'g' }, { name: 'Cheese', qty: 0.2, unit: 'kg', notes: 'Grated' }, { name: 'Ginger', qty: 50, unit: 'g', notes: 'Paste' }, { name: 'Garlic', qty: 50, unit: 'g', notes: 'Paste' }, { name: 'Cardamom', qty: 10, unit: 'g' }],
  ...
  { itemName: 'Mutton Galouti Kabab', summary: 'Melt-in-the-mouth minced mutton kababs from the Lucknowi tradition.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '2 pieces per portion',
    ingredients: [{ name: 'Mutton', qty: 2, unit: 'kg', notes: 'Finely minced, tenderised' }, { name: 'Curd', qty: 0.2, unit: 'kg' }, { name: 'Ginger', qty: 40, unit: 'g', notes: 'Paste' }, { name: 'Garlic', qty: 40, unit: 'g', notes: 'Paste' }, { name: 'Garam Masala', qty: 20, unit: 'g' }, { name: 'Ghee', qty: 150, unit: 'g', notes: 'For shallow frying' }],
  ...
  { itemName: 'Fish Curry', summary: 'Tangy coconut-based fish curry in the coastal tradition.', yieldQty: 10, yieldUnit: 'kg', yieldNotes: 'Serves approximately 50 guests as a buffet dish',
    ingredients: [{ name: 'Fish', qty: 4, unit: 'kg', notes: 'Curry cut steaks' }, { name: 'Coconut', qty: 2, unit: 'piece', notes: 'Ground into paste' }, { name: 'Onion', qty: 0.8, unit: 'kg', notes: 'Chopped' }, { name: 'Tomato', qty: 0.8, unit: 'kg', notes: 'Chopped' }, { name: 'Turmeric', qty: 20, unit: 'g' }, { name: 'Red Chilli Powder', qty: 40, unit: 'g' }],
  ...
  { itemName: 'Baingan Bharta', summary: 'Smoky roasted and mashed eggplant cooked with onion and tomato.', yieldQty: 8, yieldUnit: 'kg', yieldNotes: 'Serves approximately 50 guests as a buffet dish',
    ingredients: [{ name: 'Brinjal', qty: 5, unit: 'kg', notes: 'Whole, for open-flame roasting' }, { name: 'Onion', qty: 1, unit: 'kg', notes: 'Chopped' }, { name: 'Tomato', qty: 1, unit: 'kg', notes: 'Chopped' }, { name: 'Green Chilli', qty: 50, unit: 'g', notes: 'Chopped' }, { name: 'Cooking Oil', qty: 0.2, unit: 'liter' }],
  ...
  { itemName: 'Mix Veg Curry', summary: 'Seasonal vegetables simmered together in a light onion-tomato spiced gravy.', yieldQty: 8, yieldUnit: 'kg', yieldNotes: 'Serves approximately 55 guests as a buffet dish',
    ingredients: [{ name: 'Potato', qty: 1.5, unit: 'kg', notes: 'Cut into cubes' }, { name: 'Carrot', qty: 1, unit: 'kg', notes: 'Cut into cubes' }, { name: 'Cauliflower', qty: 1.5, unit: 'kg', notes: 'Cut into florets' }, { name: 'French Beans', qty: 500, unit: 'g', notes: 'Cut into pieces' }, { name: 'Green Peas', qty: 0.5, unit: 'kg' }, { name: 'Onion', qty: 0.8, unit: 'kg', notes: 'Chopped' }, { name: 'Tomato', qty: 0.8, unit: 'kg', notes: 'Pureed' }, { name: 'Ginger', qty: 40, unit: 'g', notes: 'Paste' }, { name: 'Garlic', qty: 40, unit: 'g', notes: 'Paste' }, { name: 'Red Chilli Powder', qty: 25, unit: 'g' }, { name: 'Turmeric', qty: 15, unit: 'g' }],
  ...
  { itemName: 'Veg Pulao', summary: 'Fragrant basmati rice cooked with mixed vegetables and whole spices.', yieldQty: 10, yieldUnit: 'kg', yieldNotes: 'Serves approximately 60 guests as a buffet dish',
    ingredients: [{ name: 'Basmati Rice', qty: 5, unit: 'kg' }, { name: 'Carrot', qty: 0.5, unit: 'kg', notes: 'Diced' }, { name: 'French Beans', qty: 400, unit: 'g', notes: 'Diced' }, { name: 'Green Peas', qty: 0.4, unit: 'kg' }, { name: 'Onion', qty: 0.4, unit: 'kg', notes: 'Sliced' }, { name: 'Cardamom', qty: 10, unit: 'g' }, { name: 'Cinnamon', qty: 10, unit: 'g' }, { name: 'Cloves', qty: 8, unit: 'g' }, { name: 'Ghee', qty: 250, unit: 'g' }],
  ...
  { itemName: 'Kashmiri Pulao', summary: 'Mildly sweet basmati rice preparation with dry fruits and saffron.', yieldQty: 8, yieldUnit: 'kg', yieldNotes: 'Serves approximately 50 guests as a buffet dish',
    ingredients: [{ name: 'Basmati Rice', qty: 4, unit: 'kg' }, { name: 'Cashew', qty: 150, unit: 'g', notes: 'Fried, for garnish' }, { name: 'Raisins', qty: 100, unit: 'g', notes: 'Fried, for garnish' }, { name: 'Pistachios', qty: 100, unit: 'g', notes: 'Slivered' }, { name: 'Sugar', qty: 0.3, unit: 'kg' }, { name: 'Ghee', qty: 250, unit: 'g' }, { name: 'Cardamom', qty: 10, unit: 'g' }, { name: 'Saffron', qty: 1, unit: 'g', notes: 'Soaked in warm milk' }],
  ...
  { itemName: 'Curd Rice', summary: 'Comforting rice tempered with curd, mustard, and curry leaves.', yieldQty: 8, yieldUnit: 'kg', yieldNotes: 'Serves approximately 55 guests as a buffet dish',
    ingredients: [{ name: 'Rice', qty: 3, unit: 'kg' }, { name: 'Curd', qty: 3, unit: 'kg' }, { name: 'Milk', qty: 1, unit: 'liter' }, { name: 'Mustard Seeds', qty: 20, unit: 'g' }, { name: 'Curry Leaves', qty: 20, unit: 'g' }, { name: 'Green Chilli', qty: 30, unit: 'g', notes: 'Finely chopped' }, { name: 'Ginger', qty: 20, unit: 'g', notes: 'Finely chopped' }, { name: 'Cooking Oil', qty: 0.08, unit: 'liter' }],
  ...
  { itemName: 'Lemon Rice', summary: 'Tangy rice tempered with mustard seeds and roasted cashew.', yieldQty: 8, yieldUnit: 'kg', yieldNotes: 'Serves approximately 55 guests as a buffet dish',
    ingredients: [{ name: 'Rice', qty: 4, unit: 'kg' }, { name: 'Lemon', qty: 15, unit: 'piece', notes: 'Juiced' }, { name: 'Mustard Seeds', qty: 20, unit: 'g' }, { name: 'Curry Leaves', qty: 20, unit: 'g' }, { name: 'Green Chilli', qty: 40, unit: 'g', notes: 'Slit' }, { name: 'Cashew', qty: 150, unit: 'g', notes: 'Fried, for crunch' }, { name: 'Turmeric', qty: 10, unit: 'g' }, { name: 'Cooking Oil', qty: 0.1, unit: 'liter' }],
  ...
  { itemName: 'Fish Moilee', summary: 'Kerala-style fish curry in a light coconut-milk gravy.', yieldQty: 8, yieldUnit: 'kg', yieldNotes: 'Serves approximately 45 guests as a buffet dish',
    ingredients: [{ name: 'Fish', qty: 4, unit: 'kg', notes: 'Curry cut steaks' }, { name: 'Coconut', qty: 3, unit: 'piece', notes: 'Ground and extracted for milk' }, { name: 'Onion', qty: 0.8, unit: 'kg', notes: 'Sliced' }, { name: 'Ginger', qty: 50, unit: 'g', notes: 'Julienned' }, { name: 'Green Chilli', qty: 60, unit: 'g', notes: 'Slit' }, { name: 'Curry Leaves', qty: 20, unit: 'g' }, { name: 'Turmeric', qty: 20, unit: 'g' }, { name: 'Cooking Oil', qty: 0.15, unit: 'liter', notes: 'Coconut oil preferred' }],
  ...
  { itemName: 'Veg Kolhapuri', summary: 'Mixed vegetables in a spicy Kolhapuri-style roasted coconut masala.', yieldQty: 8, yieldUnit: 'kg', yieldNotes: 'Serves approximately 55 guests as a buffet dish',
    ingredients: [{ name: 'Potato', qty: 1, unit: 'kg', notes: 'Cubed' }, { name: 'Cauliflower', qty: 1, unit: 'kg', notes: 'Florets' }, { name: 'Green Peas', qty: 0.5, unit: 'kg' }, { name: 'Capsicum', qty: 0.5, unit: 'kg', notes: 'Cubed' }, { name: 'Coconut', qty: 1, unit: 'piece', notes: 'Roasted and ground' }, { name: 'Coriander Seeds', qty: 40, unit: 'g' }, { name: 'Red Chilli Powder', qty: 40, unit: 'g' }, { name: 'Onion', qty: 0.5, unit: 'kg', notes: 'Chopped' }, { name: 'Tomato', qty: 0.5, unit: 'kg', notes: 'Chopped' }],
  ...
  { itemName: 'Amritsari Chicken Tikka', summary: 'Deep red spiced chicken tikka, Amritsari style.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '4 pieces per portion',
    ingredients: [{ name: 'Chicken', qty: 2.5, unit: 'kg', notes: 'Boneless, cut into chunks' }, { name: 'Curd', qty: 0.5, unit: 'kg' }, { name: 'Ginger', qty: 50, unit: 'g', notes: 'Paste' }, { name: 'Garlic', qty: 50, unit: 'g', notes: 'Paste' }, { name: 'Red Chilli Powder', qty: 50, unit: 'g', notes: 'Kashmiri variety, generous for the signature deep red colour' }, { name: 'Carom Seeds (Ajwain)', qty: 15, unit: 'g' }, { name: 'Lemon', qty: 4, unit: 'piece', notes: 'Juiced' }, { name: 'Cooking Oil', qty: 0.1, unit: 'liter', notes: 'For basting' }],
  ...
  { itemName: 'Chicken Reshmi Kabab', summary: 'Silky smooth minced chicken kababs, mildly spiced.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '3 pieces per portion',
    ingredients: [{ name: 'Chicken', qty: 2.5, unit: 'kg', notes: 'Finely minced' }, { name: 'Fresh Cream', qty: 300, unit: 'g' }, { name: 'Cheese', qty: 0.15, unit: 'kg', notes: 'Grated' }, { name: 'Cashew', qty: 100, unit: 'g', notes: 'Ground into paste' }, { name: 'Ginger', qty: 40, unit: 'g', notes: 'Paste' }, { name: 'Garlic', qty: 40, unit: 'g', notes: 'Paste' }, { name: 'Cardamom', qty: 10, unit: 'g' }],
  ...
  { itemName: 'Fish Tikka', summary: 'Marinated fish chunks grilled in the tandoor.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '4 pieces per portion',
    ingredients: [{ name: 'Fish', qty: 3, unit: 'kg', notes: 'Boneless, cut into chunks' }, { name: 'Curd', qty: 0.5, unit: 'kg' }, { name: 'Ginger', qty: 40, unit: 'g', notes: 'Paste' }, { name: 'Garlic', qty: 40, unit: 'g', notes: 'Paste' }, { name: 'Red Chilli Powder', qty: 30, unit: 'g' }, { name: 'Carom Seeds (Ajwain)', qty: 10, unit: 'g' }, { name: 'Lemon', qty: 4, unit: 'piece', notes: 'Juiced' }, { name: 'Cooking Oil', qty: 0.08, unit: 'liter', notes: 'For basting' }],
  ...
  { itemName: 'Paneer 65', summary: 'Spicy deep-fried paneer tossed in South Indian style seasoning.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '5 pieces per portion',
    ingredients: [{ name: 'Paneer', qty: 2.5, unit: 'kg', notes: 'Cut into bite-size cubes' }, { name: 'Curd', qty: 0.3, unit: 'kg' }, { name: 'Red Chilli Powder', qty: 40, unit: 'g' }, { name: 'Ginger', qty: 40, unit: 'g', notes: 'Paste' }, { name: 'Garlic', qty: 40, unit: 'g', notes: 'Paste' }, { name: 'Curry Leaves', qty: 30, unit: 'g' }, { name: 'Besan', qty: 0.2, unit: 'kg', notes: 'For the crisp coating' }, { name: 'Cooking Oil', qty: 1, unit: 'liter', notes: 'For deep frying' }],
  ...
  { itemName: 'Paneer Malai Tikka', summary: 'Creamy cheese-marinated cottage cheese, mildly spiced.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '4 pieces per portion',
    ingredients: [{ name: 'Paneer', qty: 2.5, unit: 'kg', notes: 'Cut into cubes' }, { name: 'Fresh Cream', qty: 400, unit: 'g' }, { name: 'Cheese', qty: 0.2, unit: 'kg', notes: 'Grated' }, { name: 'Ginger', qty: 40, unit: 'g', notes: 'Paste' }, { name: 'Garlic', qty: 40, unit: 'g', notes: 'Paste' }, { name: 'Cardamom', qty: 10, unit: 'g' }],
  ...
  { itemName: 'Dahi Kabab', summary: 'Hung curd patties, shallow fried with a crisp coating.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '3 pieces per portion',
    ingredients: [{ name: 'Curd', qty: 3, unit: 'kg', notes: 'Hung overnight to remove all whey' }, { name: 'Potato', qty: 0.5, unit: 'kg', notes: 'Boiled and mashed, for binding' }, { name: 'Green Chilli', qty: 30, unit: 'g', notes: 'Finely chopped' }, { name: 'Besan', qty: 0.15, unit: 'kg', notes: 'Roasted, for the coating' }, { name: 'Cooking Oil', qty: 0.3, unit: 'liter', notes: 'For shallow frying' }],
  ...
  { itemName: 'Crispy Corn', summary: 'Golden fried corn kernels tossed in a peppery seasoning.', yieldQty: 25, yieldUnit: 'portions',
    ingredients: [{ name: 'Sweet Corn', qty: 2.5, unit: 'kg' }, { name: 'Maida', qty: 0.4, unit: 'kg', notes: 'For the light batter coating' }, { name: 'Black Pepper', qty: 30, unit: 'g', notes: 'Freshly crushed' }, { name: 'Green Chilli', qty: 40, unit: 'g', notes: 'Finely chopped' }, { name: 'Cooking Oil', qty: 1, unit: 'liter', notes: 'For deep frying' }],
  ...
  { itemName: 'Cheese Corn Balls', summary: 'Deep-fried balls of cheese and sweet corn.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '3 pieces per portion',
    ingredients: [{ name: 'Cheese', qty: 1, unit: 'kg', notes: 'Grated' }, { name: 'Sweet Corn', qty: 1, unit: 'kg', notes: 'Boiled and lightly crushed' }, { name: 'Potato', qty: 0.5, unit: 'kg', notes: 'Boiled and mashed, for binding' }, { name: 'Maida', qty: 0.3, unit: 'kg', notes: 'For the crumb coating' }, { name: 'Cooking Oil', qty: 1, unit: 'liter', notes: 'For deep frying' }],
  ...
  { itemName: 'Spring Rolls', summary: 'Crisp fried rolls filled with julienned vegetables.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '2 pieces per portion',
    ingredients: [{ name: 'Cabbage', qty: 1.5, unit: 'kg', notes: 'Julienned' }, { name: 'Carrot', qty: 0.6, unit: 'kg', notes: 'Julienned' }, { name: 'Capsicum', qty: 0.4, unit: 'kg', notes: 'Julienned' }, { name: 'Maida', qty: 1, unit: 'kg', notes: 'For the wrapper dough' }, { name: 'Soy Sauce', qty: 60, unit: 'ml' }, { name: 'Cooking Oil', qty: 1, unit: 'liter', notes: 'For deep frying' }],
  ...
  { itemName: 'Cream of Mushroom Soup', summary: 'Velvety mushroom soup finished with cream and herbs.', yieldQty: 10, yieldUnit: 'liter', yieldNotes: 'Approximately 50 bowl portions',
    ingredients: [{ name: 'Mushroom', qty: 2, unit: 'kg', notes: 'Sliced' }, { name: 'Butter', qty: 0.2, unit: 'kg' }, { name: 'Maida', qty: 0.15, unit: 'kg', notes: 'For thickening' }, { name: 'Milk', qty: 3, unit: 'liter' }, { name: 'Fresh Cream', qty: 400, unit: 'g' }, { name: 'Black Pepper', qty: 15, unit: 'g' }],
  ...
  { itemName: 'Shahi Tukda', summary: 'Fried bread slices soaked in rabri and garnished with nuts.', yieldQty: 25, yieldUnit: 'portions', yieldNotes: '2 pieces per portion',
    ingredients: [{ name: 'Bakery Bread', qty: 3, unit: 'loaf' }, { name: 'Ghee', qty: 400, unit: 'g', notes: 'For shallow frying' }, { name: 'Milk', qty: 6, unit: 'liter', notes: 'Reduced for the rabri' }, { name: 'Sugar', qty: 0.6, unit: 'kg' }, { name: 'Cardamom', qty: 10, unit: 'g' }, { name: 'Pistachios', qty: 100, unit: 'g', notes: 'Slivered, for garnish' }, { name: 'Saffron', qty: 1, unit: 'g' }],
  ...
  { itemName: 'Fruit Custard', summary: 'Chilled custard with mixed seasonal fruits.', yieldQty: 8, yieldUnit: 'kg', yieldNotes: 'Serves approximately 55 guests as a buffet dessert',
    ingredients: [{ name: 'Milk', qty: 6, unit: 'liter' }, { name: 'Custard Powder', qty: 300, unit: 'g' }, { name: 'Sugar', qty: 0.8, unit: 'kg' }, { name: 'Seasonal Fruits', qty: 2, unit: 'kg', notes: 'Diced' }],
  ...
  { itemName: 'Rose Sherbet', summary: 'Chilled rose-flavoured sherbet, a traditional wedding welcome drink.', yieldQty: 100, yieldUnit: 'glasses',
    ingredients: [{ name: 'Rose Syrup', qty: 3, unit: 'liter' }, { name: 'Milk', qty: 5, unit: 'liter' }, { name: 'Sugar', qty: 0.5, unit: 'kg' }],
  ...
  { itemName: 'Welcome Mocktail', summary: 'Signature layered fruit mocktail crafted for the guest welcome moment.', yieldQty: 100, yieldUnit: 'glasses',
    ingredients: [{ name: 'Rose Syrup', qty: 2, unit: 'liter' }, { name: 'Lemon', qty: 2, unit: 'kg', notes: 'Juiced' }, { name: 'Mint', qty: 300, unit: 'g' }, { name: 'Sugar', qty: 0.8, unit: 'kg', notes: 'As sugar syrup' }],
  ...
  { itemName: 'Filter Coffee', summary: 'Traditional South Indian decoction coffee served frothy.', yieldQty: 100, yieldUnit: 'cups',
    ingredients: [{ name: 'Coffee Powder', qty: 500, unit: 'g' }, { name: 'Milk', qty: 8, unit: 'liter' }, { name: 'Sugar', qty: 0.8, unit: 'kg' }],
