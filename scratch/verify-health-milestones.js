...
(async () => {
  ...
  try {
    ...
    await page.waitForTimeout(1500); // allow Proposal Health's own deliveries/decisions fetch to settle

    await page.screenshot({ path: 'scratch/healthmilestones1.png', fullPage: true });
    console.log('DONE');
  } catch (e) {
