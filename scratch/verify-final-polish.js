...
(async () => {
  ...
  try {
    ...
    await page.waitForTimeout(1800); // allow Proposal Health's own convert-status fetch to settle

    await page.screenshot({ path: 'scratch/finalpolish1-health.png', fullPage: true });
    ...
    await page.waitForTimeout(1000);
    await page.screenshot({ path: 'scratch/finalpolish2-audit-view.png', fullPage: true });
