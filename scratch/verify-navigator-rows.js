...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: 'scratch/navrows1-default.png', fullPage: true });

    // Click a workspace in row 3 to confirm active-state highlighting still works correctly post-grouping.
    await page.click('button:has-text("Customer Decision")');
    await page.waitForTimeout(600);
    await page.screenshot({ path: 'scratch/navrows2-active-row3.png', fullPage: true });
